<?php
  ...
  // Get customer's checked out products from the database
  $sql =  (
  ...
  if (isset($_POST['paymentBtn'])) {
    ...
    // Query to insert into customer order and update shopping cart
    $query = (
      ...
      UPDATE shopping_cart SET paid='1' WHERE user_id=$user_id AND checkout='1';"
    );
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid pageBg">
      <?php
        // check number of rows of results
        if ($number_row == 0)
        {
        ...
        else
        {
          ...
          while($row=mysqli_fetch_array($result)){
            echo'<div class="row first_row">';
              ...
              echo '<div class="col-2 .col-md-4 text-center">';
                // Button to delete item from checkout page
    ...
    <!-- Show modal for payment function -->
    <?php
      if(!empty($showModal)){
        echo '<script>
